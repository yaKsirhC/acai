                ...
                <div className="grid grid-cols-4 font-[Inter]   text-sm pb-6">
                    ...
                    <div>
                        <div className="flex flex-col gap-8 ml-12">
                            ...
                            <div className="w-[45px] h-[2px] bg-gray-500  mt-[-20px]"></div>
                            <a href="#" className="">Website designing</a>
                            <a href="#" className="">Website Development</a>
                            <a href="#" className="">SEO Services</a>
                            <a href="#" className="">Application Design & <br /> Development</a>
                        </div>
                    </div>
                    <div>
                        <div className="flex flex-col gap-8 ml-12">
                            ...
                            <div className="w-[45px] h-[2px] bg-gray-500  mt-[-20px]"></div>
                            <button href="#" className="w-36 p-2 text-center bg-[#8e5e8a] rounded-lg dark:bg-[#B6BA64]">English</button>
                            <button href="#" className="w-36 p-2 text-left">Arabic</button>
                            <button href="#" className="w-36 p-2 text-left">French</button>
                        </div>
                    </div>
                </div>
                <hr className="dark:border-2"/>
                <div className="flex justify-between mt-4 tracking-widest mx-3 mr-10">
                <p>AçaíSwap DeFi 2023 copyright</p>
                <div className="flex gap-6 items-center mt-1">
                                <a href="#" target={"_blank"} rel="noopener noreferrer nofollow" className=""><FaFacebook className="text-[34px] hover:bg-[#4267B2] dark:hover:bg-[#4267B2] dark:hover:text-[#cbcbcb] p-[6px] bg-[#434343] dark:bg-[#d3d3d3] dark:text-[#434343] rounded-full text-[#cfcfcf]" /></a>
                                <a href="#" target={"_blank"} rel="noopener noreferrer nofollow"><AiFillInstagram className="text-4xl p-[6px] bg-[#434343] hover:bg-[#E1306C] dark:hover:bg-[#E1306C] dark:hover:text-[#cbcbcb] dark:bg-[#d3d3d3] dark:text-[#434343] rounded-full text-[#cfcfcf]" /></a>
                                <a href="#" target={"_blank"} rel="noopener noreferrer nofollow"><FaLinkedin className="text-[34px] p-[6px] hover:bg-[#0077b5] bg-[#434343] dark:hover:bg-[#4267B2] dark:hover:text-[#cbcbcb] dark:bg-[#d3d3d3] dark:text-[#434343] rounded-full text-[#cfcfcf]" /></a>
                            </div>
                            </div>
