    ...
    <div className=" bg-[#1E1E1E] plz-be-over pt-[60px] dark:bg-[#fdfbea]">
      ...
      <div className="grid grid-cols-2" id="Home">
          ...
          <div className="ml-24 mt-24">
            <h1 className="text-[40px] text-white dark:text-black font-semibold">
              ...
              <span className="text-[#E03D3D]">
                <TypingAnimation
                  sequence={["DeFi", 2000, "NFTFi", 2000, "GameFi", 3000]}
                />
              </span>{" "}
              <br />
            ...
            <p className="mr-16 mt-4 text-white dark:text-black text-[18px]">
              We support our community providing new ways to manage assets,
              invest and profit. <br />
              Now you can earn based on strategy, creativity and other skills.
              Join us and enjoy a whole new world full of opportunities with
              more diversity and less fees!
            </p>
            <div className="flex gap-8 my-6">
              <a href="https://acaiswap.finance/" target="_blank">
                <button className="text-white p-3 px-10 rounded-full bg-gradient-to-r from-[#8E5E8A] to-[#471443]/50 dark:from-[#B6BA64] dark:to-[#636715]">
                  Enter App
                </button>
              </a>
              <a href="https://whitepaper.acaiswap.finance/" target="_blank">
                <button className="border text-[#976b93] dark:text-[#B6BA64] border-[#956891] dark:border-[#B6BA64] p-3 px-10 rounded-full hover:text-white hover:border-[#976b93]">
                  Read Doc
                </button>
              </a>
            </div>
        ...
        <div className="col-span-1">
          <div className="mt-8">
            <img
              className="absolute top-[27px] right-0 w-[350px] bg-light"
              src={light1}
              alt=""
            />
            <img
              className="absolute top-[507px] left-0 bg-light"
              src={light2}
              alt=""
            />
            <img
              className="absolute top-[1287px] right-0 w-[350px] bg-light"
              src={light1}
              alt=""
            />
            <img className="absolute top-[1755px] left-0" src={light3} alt="" />
            <img
              className="absolute top-[2484px] right-0"
              src={light4}
              alt=""
            />
            <img
              className="absolute top-[27px] right-0 w-[350px] bg-dark"
              src={light4}
              alt=""
            />
            <img
              className="absolute top-[507px] left-0 bg-dark"
              src={light3}
              alt=""
            />
            <img
              className="absolute top-[1287px] right-0 w-[350px] bg-dark"
              src={light4}
              alt=""
            />
            <div className="w-full flex justify-start pl-36">
              <img
                src={HeroImg}
                alt=""
                className="h-[25rem] relative right-6"
              />
            </div>
            <p className="hero-paragraph text-[18px] pt-16 mr-20 font-[inter]">
              AçaíSwap was born in Brazil, inspired in the largest rainforest in
              the world: Amazon! With that in mind, AçaíSwap brings to its
              community a completely new range of opportunities in DeFi, joining
              benefits, incentives, and new ways of investment. Take a tour
              through our website and discover all the exciting news waiting for
              you!
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col font-[Inter]">
        <div className="my-3 ">
          <h1 className="text-[#8E5E8A] dark:text-[#B6BA64] text-[28px] font-bold">
            Product and Features
          </h1>
          <p className="pt-3 text-white dark:text-black text-[18px] mr-72">
            Here you check what is waiting for you in our ecosystem. Hover the
            mouse through the icons on the right to read a brief explanation of
            each one
          </p>
        </div>
      ...
      <div
        ...
        id="Roadmap"
      >
        <h1 className="text-[#8E5E8A] dark:text-[#B6BA64] text-[34px] font-bold">
          ROADMAP
        </h1>
        <p className="text-white font-medium font-[Inter]">
          Here you can follow our entire journey including project updates and
          releases.
        </p>
      </div>
      ...
      {/* Section - Tokenomics */}
      <div
        className="grid grid-cols-2 mt-12 ml-24 font-[Inter]"
        id="Tokenomics"
      >
        <div className="my-3 ">
          <h1 className="text-[#8E5E8A] dark:text-[#B6BA64] text-[28px] font-bold">
          ...
          <p className="pt-3 text-white dark:text-black text-[18px] mr-80">
            Here you can see our economic distribution and <br /> details about
            our token
          </p>
        </div>
        <div></div>
      ...
      <div className="flex flex-col justify-center items-center w-screen my-12">
        <h1 className="text-[#8E5E8A] dark:text-[#B6BA64] text-[24px] font-bold my-8">
          Token Distribution
        </h1>
        <div className="grid grid-cols-2 gap-0 w-full">
          <div className="w-full h-full flex flex-col justify-center items-center">
            <img
              className="token-distribution w-[850px]"
              src={TokenDistributionSvg}
              alt="Token Distribution"
            />
            <img
              className="token-distribution-dark w-[850px]"
              src={TokenDistributionSvgDark}
              alt=""
            />
            <p className="text-white dark:text-black font-semibold">
              a. Burn 400.000.000 tokens per year in the 4 initial years. Buy
              back and burn
              <br className="mb-2" />
              b. We don’t have token allocation for: Reserve, Advisors, Team,
              Investors, Partners
            </p>
          </div>
      ...
      {/* Section - Team */}
      <div className="mx-24 my-12 pb-24">
        <div className="grid grid-cols-2 font-[Inter]">
          <div className="my-3 ">
            ...
            <p className="pt-3 text-white dark:text-black text-[18px] mr-80">
              These are the brave who joined us to make this project possible
            </p>
          </div>
          <div></div>
        </div>
        ...
        <div className="mx-24 my-12">
          <div className="grid grid-cols-2 font-[Inter]">
            <div className="my-3 ">
              ...
              <p className="pt-3 text-white dark:text-black text-[18px] mr-64">
                These are some of the Big Ones that partnered with us, helping
                on the mission of deliver the best ecosystem experience ever!
              </p>
            </div>
            <div></div>
          </div>
        ...
        <div className="mt-24 mx-24">
          <div className="grid grid-cols-2 font-[Inter]">
            <div className="my-3 ">
              ...
              <p className="pt-3 text-white dark:text-black text-[18px] mr-64">
                Here you can see all blockchains we will operate
              </p>
            </div>
            <div></div>
          </div>
      ...
      >
        ...
        <p className="text-white dark:text-black font-medium font-[Inter]">
          Partnerships, ideas, suggestions and more!
        </p>
        <div className="pt-6">
          <ContactUs />
        </div>
      ...
      <div className="pb-24 my-16 w-full" id="News">
        <div className="mx-24 my-12">
          <div className="grid grid-cols-2 font-[Inter]">
            <div className="my-3 ">
              <h1 className="text-[#8E5E8A] dark:text-[#B6BA64] text-[28px] font-bold">
      ...
      <div className="grid grid-cols-2 mt-12 ml-24 font-[Inter]">
        <div className="my-3 ">
          <h1 className="text-[#8E5E8A] dark:text-[#B6BA64] text-[28px] font-bold">
            Trending News
          </h1>
      ...
      <div className="flex items-center h-auto justify-center gap-4 mt-[52px] mb-[77px]">
        <TrendingNews />
      </div>
      ...
      <div className="flex flex-col justify-center items-center my-12 font-[Inter]">
        <div className="w-[800px] bg-[#161616] p-12 rounded-3xl flex justify-center items-center text-white flex-col gap-3">
          ...
          <p className="text-center">
            Join our community on discord and keep updated with news, contests
            and much more!
          </p>
          <a
            href="#"
